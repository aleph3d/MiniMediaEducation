<?php
//Database Settings of your MiniMediaEducation Database
define("dbhost","localhost");
define("dbname","MiniMediaEducation");
define("dbuser","someuser");
define("dbpass","changeme");
define("dbprfx","cx11-");
//Paths
// the path to the A3N-ps folder - it is a good idea to place this a level above the Web Root.
define("pathPrivate","/home/hannah/drive/MiniMediaEducation-ps/");
